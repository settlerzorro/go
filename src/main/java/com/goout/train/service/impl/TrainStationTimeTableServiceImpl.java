...
import com.goout.train.model.response.TrainStationTimeTable;
...
@Service("trainStationTimeTableService")
public class TrainStationTimeTableServiceImpl implements ITrainStationTimeTableService {
    private static final Logger logger = LoggerFactory.getLogger(TrainStationTimeTableServiceImpl.class);
