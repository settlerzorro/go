...
//------------------------------------------------以上飞机------------------------------------------------------------------------------------------------------
    ...
    @GetMapping(value = "getTransportListBest")
    public RestResponse getTransportListBest(@RequestParam(value = "userId",required = false) Integer userId, HttpServletRequest request
            , @RequestParam("fromCity") String fromCity
            , @RequestParam("toCity") String toCity
            , @RequestParam("fromDate") String fromDate) throws ParseException {
        Map map = new HashMap();
